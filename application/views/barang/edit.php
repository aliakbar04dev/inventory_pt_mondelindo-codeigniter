        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('barang') ?>" class="btn btn-sm btn-danger btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="gambar">Gambar</label>
                    <div class="col-md-9">
                    <div class="row">
                            <div class="col-3">
                                <img src="<?= base_url() ?>assets/img/barang/<?= $barang['gambar']; ?>" alt="<?= $barang['gambar']; ?>" class="rounded-circle shadow-sm img-thumbnail">
                            </div>
                            <div class="col-9">
