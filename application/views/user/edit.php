        ...
        <div class="card shadow-sm mb-4 border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('user') ?>" class="btn btn-sm btn-danger btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'atasan' ? 'checked' : ''; ?> <?= set_radio('role', 'atasan'); ?> value="atasan" type="radio" id="atasan" name="role" class="custom-control-input">
