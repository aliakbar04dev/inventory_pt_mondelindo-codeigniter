...
<head>
    ...
    <title><?= $title; ?> | PT MONDELINDO ABADI MANDIRI</title>

    <!-- Custom fonts for this template-->
    <link href="<?= base_url('assets/'); ?>img/logo_pt.jpeg" rel="shortcut icon">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <img src="<?= base_url('assets/'); ?>img/logo_pt.jpeg" width="4%">&nbsp;&nbsp;
                    <h1 class="h5 text-primary mt-4"><b>PT.MONDELINDO ABADI MANDIRI</b></h1>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <marquee><b style="color: #224abe;">COPYRIGHT &copy; <?= date('Y'); ?> PT.MONDELINDO ABADI MANDIRI - JL. TAMAN JUANDA NO.6, RT.007/RW.004, DUREN JAYA, KEC. BEKASI TIMUR., KOTA BEKASI, JAWA BARAT 17111</b></marquee>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
