...
class Laporan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $mulai = date('D-m-d', strtotime($pecah[0]));
    ...
    private function _cetak($data, $table_, $tanggal)
    {
        ...
        $pdf->Image('assets/img/logo_pt.jpeg', 10, 10, 28);
        $pdf->SetFont('Times', 'I', 18);
        $pdf->Cell(190, 7, 'PT.MONDELINDO ABADI MANDIRI ', 0, 1, 'C');
        ...
        if ($table_ == 'barang_masuk') :
            ...
            foreach ($data as $d) {
                ...
                $pdf->Cell(55, 7, $d['nama_supplier'], 1, 0, 'C');
            ...
            foreach ($data as $d) {
                ...
                $pdf->Cell(95, 7, $d['nama_barang'], 1, 0, 'C');
